...
const DropZone: React.FC<IDropZoneProps> = ({ setGPTSummary }) => {
  ...
  const onDrop = useCallback(
    (e: DragEvent<HTMLDivElement>) => {
      ...
      if (pdfFiles.length > 0) {
        ...
        postSummary(file, setGPTSummary, setLoading, showToast);
      } else {
  ...
  return (
    <div className="bg-white flex flex-col w-2/4 max_md:w-full  p-4.5 space-y-6 justify-start rounded-xl h-full">
